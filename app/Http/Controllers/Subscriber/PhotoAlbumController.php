...
use LaraCall\Http\Requests\Admin\PhotoAlbumRequest;
use Illuminate\Support\Facades\Auth;
use Datatables;

class PhotoAlbumController extends SubscriberController
{
    ...
    */
    ...
    public function data()
    {
        ...
        return Datatables::of($photo_albums)
            ->edit_column('images_count', '<a class="btn btn-primary btn-sm" >{{ \LaraCall\Photo::where(\'photo_album_id\', \'=\', $id)->count() }}</a>')
