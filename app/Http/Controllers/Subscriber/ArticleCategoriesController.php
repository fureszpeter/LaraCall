...
namespace LaraCall\Http\Controllers\Subscriber;

use LaraCall\ArticleCategory;
use LaraCall\Language;
use LaraCall\Http\Controllers\SubscriberController;
use LaraCall\Http\Requests\Admin\ArticleCategoryRequest;
use LaraCall\Http\Requests\Admin\DeleteRequest;
use LaraCall\Http\Requests\Admin\ReorderRequest;
use Illuminate\Support\Facades\Auth;
use Datatables;

class ArticleCategoriesController extends SubscriberController
{
